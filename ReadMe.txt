Bisection Method calculates:

We want to design a ball throwing robot arm that will throw a ball with initial  velocity V0at  an  angle θ
to  the  ground  plane. Assuming  that  the robot arm is at coordinates x= 0 the ball will hit the ground 
at xf= (Vo^2 * sin2θ)/g  where g=9.8 m/s^^2 is the gravitational constant.
We want to ensure that the ball hits the ground at xf= 0.1730861meters.
